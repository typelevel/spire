...
import spire.math.{Interval, Rational, Searching}
...
final class IntervalSeq[T] private (val belowAll: Boolean,
                                    ...
                                    implicit private val order: Order[T]
...
object IntervalSeq {
  ...
  implicit def algebra[T: Order]: Bool[IntervalSeq[T]] with Eq[IntervalSeq[T]] = new Bool[IntervalSeq[T]]
  ...
  final private val K10 = 1

  final private val K01 = 2

  final private val K11 = 3
  ...
  abstract private class MergeOperation[T] {
  ...
  abstract private class BooleanOperation[T] {
  ...
  final private class IntervalIterator[T: Order](s: IntervalSeq[T]) extends Iterator[Interval[T]] {
