...
object ValueBound {
   ...
   */
  @inline def union3_1approx2_2less3[A: Order](v1: ValueBound[A], v2: ValueBound[A], v3: ValueBound[A]): Interval[A] =
   ...
   * Assumption: v1.a < v2.a === v3.a.
   */
  @inline def union3_1less2_2approx3[A: Order](v1: ValueBound[A], v2: ValueBound[A], v3: ValueBound[A]): Interval[A] =
   ...
   * Assumption: v1.a === v2.a === v3.a.
   */
  @inline def union3_1approx2_2approx3[A: Order](v1: ValueBound[A], v2: ValueBound[A], v3: ValueBound[A]): Interval[A] =
   ...
   */
  @inline def union3_1approx2[A: Order](v1: ValueBound[A], v2: ValueBound[A], v3: ValueBound[A]): Interval[A] =
    v2.a.compare(v3.a).sign match {
      case -1 => // v1 ~ v2 < v3
   ...
   * Assumption: v1.a < v2.a.
   */
  @inline def union3_1less2[A: Order](v1: ValueBound[A], v2: ValueBound[A], v3: ValueBound[A]): Interval[A] =
    v2.a.compare(v3.a).sign match {
      case -1 => // v1 < v2 < v3
        Interval.fromOrderedBounds(v1, v3)
      case 1 => // v1 < v2 and v3 < v2
        v1.a.compare(v3.a).sign match {
          case -1 => // v1 < v3 < v2
            Interval.fromOrderedBounds(v1, v2)
          case 1 => // v3 < v1 < v2
   ...
   * Returns the interval which contains all the given bounds.
   */
  @inline def union3[A: Order](v1: ValueBound[A], v2: ValueBound[A], v3: ValueBound[A]): Interval[A] =
    v1.a.compare(v2.a).sign match {
      case -1 => // v1 < v2
   ...
   */
  @inline def union4_1approx2_2approx3_3less4[A: Order](v1: ValueBound[A],
                                                        v2: ValueBound[A],
                                                        v3: ValueBound[A],
                                                        v4: ValueBound[A]
  ): Interval[A] =
   ...
   * Assumption: v1.a === v2.a < v3.a === v4.a.
   */
  @inline def union4_1approx2_2less3_3approx4[A: Order](v1: ValueBound[A],
                                                        v2: ValueBound[A],
                                                        v3: ValueBound[A],
                                                        v4: ValueBound[A]
  ): Interval[A] =
   ...
   * Assumption: v1.a < v2.a === v3.a === v4.a.
   */
  @inline def union4_1less2_2approx3_3approx4[A: Order](v1: ValueBound[A],
                                                        v2: ValueBound[A],
                                                        v3: ValueBound[A],
                                                        v4: ValueBound[A]
  ): Interval[A] =
   ...
   */
  @inline def union4_1less3_2less3_3approx4[A: Order](v1: ValueBound[A],
                                                      v2: ValueBound[A],
                                                      v3: ValueBound[A],
                                                      v4: ValueBound[A]
  ): Interval[A] =
   ...
   * Assumption: v1.a < v2.a === v3.a.
   */
  @inline def union4_1less2_2approx3[A: Order](v1: ValueBound[A],
                                               v2: ValueBound[A],
                                               v3: ValueBound[A],
                                               v4: ValueBound[A]
  ): Interval[A] =
    v3.a.compare(v4.a).sign match {
      case -1 => // v1 < v2 ~ v3 < v4
        Interval.fromOrderedBounds(v1, v4)
      case 0 => // v1 < v2 ~ v3 ~ v4
   ...
   * Assumption: v1.a === v2.a < v3.a.
   */
  @inline def union4_1approx2_2less3[A: Order](v1: ValueBound[A],
                                               v2: ValueBound[A],
                                               v3: ValueBound[A],
                                               v4: ValueBound[A]
  ): Interval[A] =
   ...
   * Assumption: v1.a === v2.a == v3.a.
   */
  @inline def union4_1approx2_2approx3[A: Order](v1: ValueBound[A],
                                                 v2: ValueBound[A],
                                                 v3: ValueBound[A],
                                                 v4: ValueBound[A]
  ): Interval[A] =
   ...
   * Assumption: v1.a === v2.a.
   */
  @inline def union4_1approx2[A: Order](v1: ValueBound[A],
                                        v2: ValueBound[A],
                                        v3: ValueBound[A],
                                        v4: ValueBound[A]
  ): Interval[A] =
   ...
   */
  @inline def union4_1less2_1less3[A: Order](v1: ValueBound[A],
                                             v2: ValueBound[A],
                                             v3: ValueBound[A],
                                             v4: ValueBound[A]
  ): Interval[A] =
   ...
   */
  @inline def union4_1less3_2less3[A: Order](v1: ValueBound[A],
                                             v2: ValueBound[A],
                                             v3: ValueBound[A],
                                             v4: ValueBound[A]
  ): Interval[A] =
   ...
   * Returns the interval which contains all the given bounds.
   */
  @inline def union4[A: Order](v1: ValueBound[A],
                               v2: ValueBound[A],
                               v3: ValueBound[A],
                               v4: ValueBound[A]
  ): Interval[A] =
