 ...
 *
 * The seeding functions are an adaptation/port of code from the the 32-bit and 64-bit implementations of
 * MersenneTwister (MT19937.c, MT19937-64.c).
 *
 ...
 *
 * <p><b>Reference: </b> Makato Matsumoto and Takuji Nishimura: "Mersenne Twister: A 623-Dimensionally Equidistributed
