...
extends ScalaNumber with ScalaNumericConversions with Serializable {
   ...
   */
  def t_/~(that: Algebraic): Algebraic =
...
private[math] trait AlgebraicIsReal extends IsAlgebraic[Algebraic] with TruncatedDivisionCRing[Algebraic] {
  ...
  def tquot(x: Algebraic, y: Algebraic): Algebraic = x t_/~ y
  def tmod(x: Algebraic, y: Algebraic): Algebraic = x t_% y
