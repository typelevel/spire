...
trait ByteIsEuclideanRing extends EuclideanRing[Byte] {
  ...
  override def gcd(a: Byte, b: Byte)(implicit ev: Eq[Byte]): Byte = spire.math.gcd(a: Long, b: Long).toByte
  override def lcm(a: Byte, b: Byte)(implicit ev: Eq[Byte]): Byte = spire.math.lcm(a: Long, b: Long).toByte
}
