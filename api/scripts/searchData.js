...
{"l":"spire/NoImplicit.html","n":"NoImplicit","t":"class NoImplicit[A]","d":"spire/NoImplicit","k":"class"},
{"l":"spire/NoImplicit$.html","n":"NoImplicit","t":"object NoImplicit","d":"spire/NoImplicit$","k":"object"},
{"l":"spire/NoImplicit$.html","n":"noImplicit0","t":"def noImplicit0[A]: NoImplicit[A]","d":"spire/NoImplicit$","k":"def"},
{"l":"spire/NoImplicit$.html","n":"noImplicit1","t":"def noImplicit1[A](implicit ev: A): NoImplicit[A]","d":"spire/NoImplicit$","k":"def"},
...
{"l":"spire/algebra.html","n":"AlgebraField","t":"type AlgebraField[A] = Field[A]","d":"spire/algebra","k":"type"},
{"l":"spire/algebra.html","n":"AlgebraField","t":"val AlgebraField: Field","d":"spire/algebra","k":"val"},
...
{"l":"spire/algebra/DivisionRing.html","n":"DivisionRing","t":"trait DivisionRing[@specialized(Byte, Short, Int, Long, Float, Double) A] extends Ring[A] with MultiplicativeGroup[A]","d":"spire/algebra/DivisionRing","k":"trait"},
{"l":"spire/algebra/DivisionRing.html","n":"fromDouble","t":"def fromDouble(a: Double): A","d":"spire/algebra/DivisionRing","k":"def"},
{"l":"spire/algebra/DivisionRing$.html","n":"DivisionRing","t":"object DivisionRing","d":"spire/algebra/DivisionRing$","k":"object"},
{"l":"spire/algebra/DivisionRing$.html","n":"apply","t":"def apply[A](implicit f: DivisionRing[A]): DivisionRing[A]","d":"spire/algebra/DivisionRing$","k":"def"},
{"l":"spire/algebra/EuclideanRing.html","n":"EuclideanRing","t":"trait EuclideanRing[@specialized(Int, Long, Float, Double) A] extends GCDRing[A]","d":"spire/algebra/EuclideanRing","k":"trait"},
{"l":"spire/algebra/EuclideanRing.html","n":"emod","t":"def emod(a: A, b: A): A","d":"spire/algebra/EuclideanRing","k":"def"},
{"l":"spire/algebra/EuclideanRing.html","n":"equot","t":"def equot(a: A, b: A): A","d":"spire/algebra/EuclideanRing","k":"def"},
{"l":"spire/algebra/EuclideanRing.html","n":"equotmod","t":"def equotmod(a: A, b: A): (A, A)","d":"spire/algebra/EuclideanRing","k":"def"},
{"l":"spire/algebra/EuclideanRing.html","n":"euclideanFunction","t":"def euclideanFunction(a: A): BigInt","d":"spire/algebra/EuclideanRing","k":"def"},
{"l":"spire/algebra/EuclideanRing$.html","n":"EuclideanRing","t":"object EuclideanRing extends EuclideanRingFunctions[EuclideanRing]","d":"spire/algebra/EuclideanRing$","k":"object"},
{"l":"spire/algebra/EuclideanRing$.html","n":"apply","t":"def apply[A](implicit e: EuclideanRing[A]): EuclideanRing[A]","d":"spire/algebra/EuclideanRing$","k":"def"},
{"l":"spire/algebra/EuclideanRing$.html","n":"euclid","t":"def euclid[@specialized(Int, Long, Float, Double) A : EuclideanRing](a: A, b: A): A","d":"spire/algebra/EuclideanRing$","k":"def"},
{"l":"spire/algebra/EuclideanRing$$WithEuclideanAlgorithm.html","n":"WithEuclideanAlgorithm","t":"trait WithEuclideanAlgorithm[@specialized(Int, Long, Float, Double) A] extends EuclideanRing[A]","d":"spire/algebra/EuclideanRing$$WithEuclideanAlgorithm","k":"trait"},
{"l":"spire/algebra/EuclideanRing$$WithEuclideanAlgorithm.html","n":"gcd","t":"def gcd(a: A, b: A)(implicit ev: Eq[A]): A","d":"spire/algebra/EuclideanRing$$WithEuclideanAlgorithm","k":"def"},
{"l":"spire/algebra/EuclideanRing$$WithEuclideanAlgorithm.html","n":"lcm","t":"def lcm(a: A, b: A)(implicit ev: Eq[A]): A","d":"spire/algebra/EuclideanRing$$WithEuclideanAlgorithm","k":"def"},
{"l":"spire/algebra/EuclideanRingFunctions.html","n":"EuclideanRingFunctions","t":"trait EuclideanRingFunctions[R <: (EuclideanRing)] extends GCDRingFunctions[R]","d":"spire/algebra/EuclideanRingFunctions","k":"trait"},
{"l":"spire/algebra/EuclideanRingFunctions.html","n":"emod","t":"def emod[@specialized(Int, Long, Float, Double) A](a: A, b: A)(implicit ev: R[A]): A","d":"spire/algebra/EuclideanRingFunctions","k":"def"},
{"l":"spire/algebra/EuclideanRingFunctions.html","n":"equot","t":"def equot[@specialized(Int, Long, Float, Double) A](a: A, b: A)(implicit ev: R[A]): A","d":"spire/algebra/EuclideanRingFunctions","k":"def"},
{"l":"spire/algebra/EuclideanRingFunctions.html","n":"equotmod","t":"def equotmod[@specialized(Int, Long, Float, Double) A](a: A, b: A)(implicit ev: R[A]): (A, A)","d":"spire/algebra/EuclideanRingFunctions","k":"def"},
{"l":"spire/algebra/EuclideanRingFunctions.html","n":"euclideanFunction","t":"def euclideanFunction[@specialized(Int, Long, Float, Double) A](a: A)(implicit ev: R[A]): BigInt","d":"spire/algebra/EuclideanRingFunctions","k":"def"},
{"l":"spire/algebra/Field.html","n":"Field","t":"trait Field[@specialized(Int, Long, Float, Double) A] extends Field[A] with EuclideanRing[A]","d":"spire/algebra/Field","k":"trait"},
{"l":"spire/algebra/Field.html","n":"emod","t":"def emod(a: A, b: A): A","d":"spire/algebra/Field","k":"def"},
{"l":"spire/algebra/Field.html","n":"equot","t":"def equot(a: A, b: A): A","d":"spire/algebra/Field","k":"def"},
{"l":"spire/algebra/Field.html","n":"euclideanFunction","t":"def euclideanFunction(a: A): BigInt","d":"spire/algebra/Field","k":"def"},
{"l":"spire/algebra/Field$.html","n":"Field","t":"object Field extends FieldFunctions[Field] with EuclideanRingFunctions[Field]","d":"spire/algebra/Field$","k":"object"},
{"l":"spire/algebra/Field$.html","n":"apply","t":"def apply[A](implicit ev: Field[A]): Field[A]","d":"spire/algebra/Field$","k":"def"},
{"l":"spire/algebra/Field$$FieldOfFractionsGCD.html","n":"FieldOfFractionsGCD","t":"trait FieldOfFractionsGCD[A, R] extends Field[A]","d":"spire/algebra/Field$$FieldOfFractionsGCD","k":"trait"},
{"l":"spire/algebra/Field$$FieldOfFractionsGCD.html","n":"denominator","t":"def denominator(a: A): R","d":"spire/algebra/Field$$FieldOfFractionsGCD","k":"def"},
{"l":"spire/algebra/Field$$FieldOfFractionsGCD.html","n":"eqR","t":"def eqR: Eq[R]","d":"spire/algebra/Field$$FieldOfFractionsGCD","k":"def"},
{"l":"spire/algebra/Field$$FieldOfFractionsGCD.html","n":"fraction","t":"def fraction(num: R, den: R): A","d":"spire/algebra/Field$$FieldOfFractionsGCD","k":"def"},
{"l":"spire/algebra/Field$$FieldOfFractionsGCD.html","n":"numerator","t":"def numerator(a: A): R","d":"spire/algebra/Field$$FieldOfFractionsGCD","k":"def"},
{"l":"spire/algebra/Field$$FieldOfFractionsGCD.html","n":"ringR","t":"def ringR: GCDRing[R]","d":"spire/algebra/Field$$FieldOfFractionsGCD","k":"def"},
{"l":"spire/algebra/Field$$WithDefaultGCD.html","n":"WithDefaultGCD","t":"trait WithDefaultGCD[@specialized(Int, Long, Float, Double) A] extends Field[A]","d":"spire/algebra/Field$$WithDefaultGCD","k":"trait"},
...
{"l":"spire/algebra/GCDRing.html","n":"GCDRing","t":"trait GCDRing[@specialized(Int, Long, Float, Double) A] extends CommutativeRing[A]","d":"spire/algebra/GCDRing","k":"trait"},
{"l":"spire/algebra/GCDRing.html","n":"gcd","t":"def gcd(a: A, b: A)(implicit ev: Eq[A]): A","d":"spire/algebra/GCDRing","k":"def"},
{"l":"spire/algebra/GCDRing.html","n":"lcm","t":"def lcm(a: A, b: A)(implicit ev: Eq[A]): A","d":"spire/algebra/GCDRing","k":"def"},
{"l":"spire/algebra/GCDRing$.html","n":"GCDRing","t":"object GCDRing extends GCDRingFunctions[GCDRing]","d":"spire/algebra/GCDRing$","k":"object"},
{"l":"spire/algebra/GCDRing$.html","n":"apply","t":"def apply[A](implicit ev: GCDRing[A]): GCDRing[A]","d":"spire/algebra/GCDRing$","k":"def"},
{"l":"spire/algebra/GCDRingFunctions.html","n":"GCDRingFunctions","t":"trait GCDRingFunctions[R <: (GCDRing)] extends RingFunctions[R]","d":"spire/algebra/GCDRingFunctions","k":"trait"},
{"l":"spire/algebra/GCDRingFunctions.html","n":"gcd","t":"def gcd[@specialized(Int, Long, Float, Double) A](a: A, b: A)(implicit ev: R[A], eqA: Eq[A]): A","d":"spire/algebra/GCDRingFunctions","k":"def"},
{"l":"spire/algebra/GCDRingFunctions.html","n":"lcm","t":"def lcm[@specialized(Int, Long, Float, Double) A](a: A, b: A)(implicit ev: R[A], eqA: Eq[A]): A","d":"spire/algebra/GCDRingFunctions","k":"def"},
...
{"l":"spire/algebra/IsReal.html","n":"IsReal","t":"trait IsReal[@specialized A] extends Signed[A]","d":"spire/algebra/IsReal","k":"trait"},
...
{"l":"spire/algebra/Sign.html","n":"Sign","t":"class Sign(val toInt: Int)","d":"spire/algebra/Sign","k":"class"},
{"l":"spire/algebra/Sign.html","n":"*","t":"def *(that: Sign): Sign","d":"spire/algebra/Sign","k":"def"},
{"l":"spire/algebra/Sign.html","n":"**","t":"def **(that: Int): Sign","d":"spire/algebra/Sign","k":"def"},
{"l":"spire/algebra/Sign.html","n":"toInt","t":"val toInt: Int","d":"spire/algebra/Sign","k":"val"},
{"l":"spire/algebra/Sign.html","n":"unary_-","t":"def unary_-: Sign","d":"spire/algebra/Sign","k":"def"},
{"l":"spire/algebra/Sign$.html","n":"Sign","t":"object Sign","d":"spire/algebra/Sign$","k":"object"},
{"l":"spire/algebra/Sign$.html","n":"SignAction","t":"def SignAction[A](implicit A: AdditiveGroup[A]): MultiplicativeAction[A, Sign]","d":"spire/algebra/Sign$","k":"def"},
{"l":"spire/algebra/Sign$.html","n":"SignAlgebra","t":"val SignAlgebra: CommutativeMonoid[Sign] & Signed[Sign]","d":"spire/algebra/Sign$","k":"val"},
{"l":"spire/algebra/Sign$.html","n":"SignMultiplicativeGroup","t":"val SignMultiplicativeGroup: MultiplicativeCommutativeMonoid[Sign]","d":"spire/algebra/Sign$","k":"val"},
{"l":"spire/algebra/Sign$.html","n":"apply","t":"def apply(i: Int): Sign","d":"spire/algebra/Sign$","k":"def"},
{"l":"spire/algebra/Sign$.html","n":"sign2int","t":"def sign2int(s: Sign): Int","d":"spire/algebra/Sign$","k":"def"},
{"l":"spire/algebra/Sign$$Negative$.html","n":"Negative","t":"object Negative extends Sign","d":"spire/algebra/Sign$$Negative$","k":"object"},
{"l":"spire/algebra/Sign$$Positive$.html","n":"Positive","t":"object Positive extends Sign","d":"spire/algebra/Sign$$Positive$","k":"object"},
{"l":"spire/algebra/Sign$$SignAlgebra.html","n":"SignAlgebra","t":"class SignAlgebra extends CommutativeMonoid[Sign] with Signed[Sign]","d":"spire/algebra/Sign$$SignAlgebra","k":"class"},
{"l":"spire/algebra/Sign$$SignAlgebra.html","n":"abs","t":"def abs(a: Sign): Sign","d":"spire/algebra/Sign$$SignAlgebra","k":"def"},
{"l":"spire/algebra/Sign$$SignAlgebra.html","n":"combine","t":"def combine(a: Sign, b: Sign): Sign","d":"spire/algebra/Sign$$SignAlgebra","k":"def"},
{"l":"spire/algebra/Sign$$SignAlgebra.html","n":"compare","t":"def compare(x: Sign, y: Sign): Int","d":"spire/algebra/Sign$$SignAlgebra","k":"def"},
{"l":"spire/algebra/Sign$$SignAlgebra.html","n":"empty","t":"def empty: Sign","d":"spire/algebra/Sign$$SignAlgebra","k":"def"},
{"l":"spire/algebra/Sign$$SignAlgebra.html","n":"signum","t":"def signum(a: Sign): Int","d":"spire/algebra/Sign$$SignAlgebra","k":"def"},
{"l":"spire/algebra/Sign$$Zero$.html","n":"Zero","t":"object Zero extends Sign","d":"spire/algebra/Sign$$Zero$","k":"object"},
{"l":"spire/algebra/Signed.html","n":"Signed","t":"trait Signed[@specialized(Byte, Short, Int, Long, Float, Double) A] extends Order[A]","d":"spire/algebra/Signed","k":"trait"},
{"l":"spire/algebra/Signed.html","n":"abs","t":"def abs(a: A): A","d":"spire/algebra/Signed","k":"def"},
{"l":"spire/algebra/Signed.html","n":"isSignNegative","t":"def isSignNegative(a: A): Boolean","d":"spire/algebra/Signed","k":"def"},
{"l":"spire/algebra/Signed.html","n":"isSignNonNegative","t":"def isSignNonNegative(a: A): Boolean","d":"spire/algebra/Signed","k":"def"},
{"l":"spire/algebra/Signed.html","n":"isSignNonPositive","t":"def isSignNonPositive(a: A): Boolean","d":"spire/algebra/Signed","k":"def"},
{"l":"spire/algebra/Signed.html","n":"isSignNonZero","t":"def isSignNonZero(a: A): Boolean","d":"spire/algebra/Signed","k":"def"},
{"l":"spire/algebra/Signed.html","n":"isSignPositive","t":"def isSignPositive(a: A): Boolean","d":"spire/algebra/Signed","k":"def"},
{"l":"spire/algebra/Signed.html","n":"isSignZero","t":"def isSignZero(a: A): Boolean","d":"spire/algebra/Signed","k":"def"},
{"l":"spire/algebra/Signed.html","n":"sign","t":"def sign(a: A): Sign","d":"spire/algebra/Signed","k":"def"},
{"l":"spire/algebra/Signed.html","n":"signum","t":"def signum(a: A): Int","d":"spire/algebra/Signed","k":"def"},
{"l":"spire/algebra/Signed$.html","n":"Signed","t":"object Signed","d":"spire/algebra/Signed$","k":"object"},
{"l":"spire/algebra/Signed$.html","n":"apply","t":"def apply[A](implicit s: Signed[A]): Signed[A]","d":"spire/algebra/Signed$","k":"def"},
{"l":"spire/algebra/SignedAdditiveAbGroup.html","n":"SignedAdditiveAbGroup","t":"trait SignedAdditiveAbGroup[@specialized(Byte, Short, Int, Long, Float, Double) A] extends SignedAdditiveCMonoid[A] with AdditiveCommutativeGroup[A]","d":"spire/algebra/SignedAdditiveAbGroup","k":"trait"},
{"l":"spire/algebra/SignedAdditiveAbGroup.html","n":"abs","t":"def abs(a: A): A","d":"spire/algebra/SignedAdditiveAbGroup","k":"def"},
{"l":"spire/algebra/SignedAdditiveCMonoid.html","n":"SignedAdditiveCMonoid","t":"trait SignedAdditiveCMonoid[@specialized(Byte, Short, Int, Long, Float, Double) A] extends Signed[A] with AdditiveCommutativeMonoid[A]","d":"spire/algebra/SignedAdditiveCMonoid","k":"trait"},
{"l":"spire/algebra/SignedAdditiveCMonoid.html","n":"signum","t":"def signum(a: A): Int","d":"spire/algebra/SignedAdditiveCMonoid","k":"def"},
...
{"l":"spire/algebra/TruncatedDivision.html","n":"TruncatedDivision","t":"trait TruncatedDivision[@specialized(Byte, Short, Int, Long, Float, Double) A] extends Signed[A]","d":"spire/algebra/TruncatedDivision","k":"trait"},
{"l":"spire/algebra/TruncatedDivision.html","n":"fmod","t":"def fmod(x: A, y: A): A","d":"spire/algebra/TruncatedDivision","k":"def"},
{"l":"spire/algebra/TruncatedDivision.html","n":"fquot","t":"def fquot(x: A, y: A): A","d":"spire/algebra/TruncatedDivision","k":"def"},
{"l":"spire/algebra/TruncatedDivision.html","n":"fquotmod","t":"def fquotmod(x: A, y: A): (A, A)","d":"spire/algebra/TruncatedDivision","k":"def"},
{"l":"spire/algebra/TruncatedDivision.html","n":"tmod","t":"def tmod(x: A, y: A): A","d":"spire/algebra/TruncatedDivision","k":"def"},
{"l":"spire/algebra/TruncatedDivision.html","n":"toBigIntOpt","t":"def toBigIntOpt(x: A): Opt[BigInt]","d":"spire/algebra/TruncatedDivision","k":"def"},
{"l":"spire/algebra/TruncatedDivision.html","n":"tquot","t":"def tquot(x: A, y: A): A","d":"spire/algebra/TruncatedDivision","k":"def"},
{"l":"spire/algebra/TruncatedDivision.html","n":"tquotmod","t":"def tquotmod(x: A, y: A): (A, A)","d":"spire/algebra/TruncatedDivision","k":"def"},
{"l":"spire/algebra/TruncatedDivision$.html","n":"TruncatedDivision","t":"object TruncatedDivision","d":"spire/algebra/TruncatedDivision$","k":"object"},
{"l":"spire/algebra/TruncatedDivision$.html","n":"apply","t":"def apply[A](implicit ev: TruncatedDivision[A]): TruncatedDivision[A]","d":"spire/algebra/TruncatedDivision$","k":"def"},
{"l":"spire/algebra/TruncatedDivision$.html","n":"fquotmodFromTquotmod","t":"def fquotmodFromTquotmod[A : Signed](x: A, y: A, tquot: A, tmod: A): (A, A)","d":"spire/algebra/TruncatedDivision$","k":"def"},
{"l":"spire/algebra/TruncatedDivisionCRing.html","n":"TruncatedDivisionCRing","t":"trait TruncatedDivisionCRing[@specialized(Byte, Short, Int, Long, Float, Double) A] extends TruncatedDivision[A] with CommutativeRing[A]","d":"spire/algebra/TruncatedDivisionCRing","k":"trait"},
{"l":"spire/algebra/TruncatedDivisionCRing.html","n":"fmod","t":"def fmod(x: A, y: A): A","d":"spire/algebra/TruncatedDivisionCRing","k":"def"},
{"l":"spire/algebra/TruncatedDivisionCRing.html","n":"fquot","t":"def fquot(x: A, y: A): A","d":"spire/algebra/TruncatedDivisionCRing","k":"def"},
...
{"l":"spire/laws/CombinationLaws.html","n":"signedAdditiveAbGroup","t":"def signedAdditiveAbGroup(implicit signedA: Signed[A], additiveAbGroupA: AdditiveCommutativeGroup[A]): DefaultRuleSet","d":"spire/laws/CombinationLaws","k":"def"},
{"l":"spire/laws/CombinationLaws.html","n":"signedAdditiveCMonoid","t":"def signedAdditiveCMonoid(implicit signedA: Signed[A], additiveCMonoidA: AdditiveCommutativeMonoid[A]): DefaultRuleSet","d":"spire/laws/CombinationLaws","k":"def"},
{"l":"spire/laws/CombinationLaws.html","n":"signedGCDRing","t":"def signedGCDRing(implicit signedA: Signed[A], gcdRingA: GCDRing[A]): DefaultRuleSet","d":"spire/laws/CombinationLaws","k":"def"},
...
{"l":"spire/laws/OrderLaws.html","n":"truncatedDivision","t":"def truncatedDivision(implicit cRigA: CommutativeRig[A], truncatedDivisionA: TruncatedDivision[A]): DefaultRuleSet","d":"spire/laws/OrderLaws","k":"def"},
...
{"l":"spire/laws/VectorSpaceLaws.html","n":"ringFromLeftModule","t":"def ringFromLeftModule(implicit V: LeftModule[V, A], ev: NoImplicit[CModule[V, A]]): Ring[A]","d":"spire/laws/VectorSpaceLaws","k":"def"},
{"l":"spire/laws/VectorSpaceLaws.html","n":"ringFromRightModule","t":"def ringFromRightModule(implicit V: RightModule[V, A], ev: NoImplicit[CModule[V, A]]): Ring[A]","d":"spire/laws/VectorSpaceLaws","k":"def"},
...
{"l":"spire/laws/shadows/ShadowGCDRing.html","n":"gcd","t":"def gcd(x: Shadow[A, S], y: Shadow[A, S])(implicit ev: Eq[Shadow[A, S]]): Shadow[A, S]","d":"spire/laws/shadows/ShadowGCDRing","k":"def"},
{"l":"spire/laws/shadows/ShadowGCDRing.html","n":"lcm","t":"def lcm(x: Shadow[A, S], y: Shadow[A, S])(implicit ev: Eq[Shadow[A, S]]): Shadow[A, S]","d":"spire/laws/shadows/ShadowGCDRing","k":"def"},
...
{"l":"spire/laws/shadows/ShadowInstances3.html","n":"signed","t":"def signed[A : Signed, S : Signed](implicit evidence$29: Signed[A], evidence$30: Signed[S], ev: Shadowing[A, S]): Signed[Shadow[A, S]]","d":"spire/laws/shadows/ShadowInstances3","k":"def"},
...
{"l":"spire/laws/shadows/ShadowInstances4.html","n":"cRig","t":"def cRig[A : CommutativeRig, S : Eq](implicit evidence$31: Eq[A], evidence$32: CommutativeRig[A], evidence$33: Eq[S], evidence$34: CommutativeRig[S], ev: Shadowing[A, S]): CommutativeRig[Shadow[A, S]]","d":"spire/laws/shadows/ShadowInstances4","k":"def"},
{"l":"spire/laws/shadows/ShadowInstances4.html","n":"cRng","t":"def cRng[A : CommutativeRng, S : CommutativeRng](implicit evidence$35: Eq[A], evidence$36: CommutativeRng[A], evidence$37: Eq[S], evidence$38: CommutativeRng[S], ev: Shadowing[A, S]): CommutativeRng[Shadow[A, S]]","d":"spire/laws/shadows/ShadowInstances4","k":"def"},
{"l":"spire/laws/shadows/ShadowInstances4.html","n":"truncatedDivision","t":"def truncatedDivision[A : TruncatedDivision, S : TruncatedDivision](implicit evidence$39: TruncatedDivision[A], evidence$40: TruncatedDivision[S], ev: Shadowing[A, S]): TruncatedDivision[Shadow[A, S]]","d":"spire/laws/shadows/ShadowInstances4","k":"def"},
...
{"l":"spire/laws/shadows/ShadowInstances5.html","n":"cRing","t":"def cRing[A : Eq, S : CommutativeRing](implicit evidence$41: Eq[A], evidence$42: CommutativeRing[A], evidence$43: Eq[S], evidence$44: CommutativeRing[S], ev: Shadowing[A, S]): CommutativeRing[Shadow[A, S]]","d":"spire/laws/shadows/ShadowInstances5","k":"def"},
...
{"l":"spire/laws/shadows/ShadowInstances6.html","n":"gcdRing","t":"def gcdRing[A : Eq, S : GCDRing](implicit evidence$45: Eq[A], evidence$46: GCDRing[A], evidence$47: Eq[S], evidence$48: GCDRing[S], ev: Shadowing[A, S]): GCDRing[Shadow[A, S]]","d":"spire/laws/shadows/ShadowInstances6","k":"def"},
...
{"l":"spire/laws/shadows/ShadowInstances7.html","n":"euclideanRing","t":"def euclideanRing[A : EuclideanRing, S : Eq](implicit evidence$49: Eq[A], evidence$50: EuclideanRing[A], evidence$51: Eq[S], evidence$52: EuclideanRing[S], ev: Shadowing[A, S]): EuclideanRing[Shadow[A, S]]","d":"spire/laws/shadows/ShadowInstances7","k":"def"},
...
{"l":"spire/laws/shadows/ShadowSigned.html","n":"ShadowSigned","t":"trait ShadowSigned[A, S] extends ShadowOrder[A, S] with Signed[Shadow[A, S]]","d":"spire/laws/shadows/ShadowSigned","k":"trait"},
...
{"l":"spire/laws/shadows/ShadowTruncatedDivision.html","n":"toBigIntOpt","t":"def toBigIntOpt(x: Shadow[A, S]): Opt[BigInt]","d":"spire/laws/shadows/ShadowTruncatedDivision","k":"def"},
...
{"l":"spire/math.html","n":"hypot","t":"def hypot[@specialized(Float, Double) A](x: A, y: A)(implicit f: Field[A], n: NRoot[A], s: Signed[A]): A","d":"spire/math","k":"def"},
...
{"l":"spire/math/AlgebraicInstances.html","n":"AlgebraicAlgebra","t":"val AlgebraicAlgebra: WithDefaultGCD[Algebraic] & NRoot[Algebraic] & IsAlgebraic[Algebraic] & TruncatedDivisionCRing[Algebraic]","d":"spire/math/AlgebraicInstances","k":"val"},
...
{"l":"spire/math/Complex.html","n":"**","t":"def **(e: T)(implicit f: Field[T], n: NRoot[T], s: Signed[T], t: Trig[T]): Complex[T]","d":"spire/math/Complex","k":"def"},
{"l":"spire/math/Complex.html","n":"**","t":"def **(b: Int)(implicit f: Field[T], n: NRoot[T], s: Signed[T], t: Trig[T]): Complex[T]","d":"spire/math/Complex","k":"def"},
{"l":"spire/math/Complex.html","n":"**","t":"def **(b: Complex[T])(implicit f: Field[T], n: NRoot[T], s: Signed[T], t: Trig[T]): Complex[T]","d":"spire/math/Complex","k":"def"},
{"l":"spire/math/Complex.html","n":"+","t":"def +(rhs: T)(implicit r: CommutativeRing[T]): Complex[T]","d":"spire/math/Complex","k":"def"},
{"l":"spire/math/Complex.html","n":"+","t":"def +(b: Complex[T])(implicit r: CommutativeRing[T]): Complex[T]","d":"spire/math/Complex","k":"def"},
{"l":"spire/math/Complex.html","n":"-","t":"def -(rhs: T)(implicit r: CommutativeRing[T]): Complex[T]","d":"spire/math/Complex","k":"def"},
{"l":"spire/math/Complex.html","n":"-","t":"def -(b: Complex[T])(implicit r: CommutativeRing[T]): Complex[T]","d":"spire/math/Complex","k":"def"},
{"l":"spire/math/Complex.html","n":"/","t":"def /(rhs: T)(implicit r: Field[T]): Complex[T]","d":"spire/math/Complex","k":"def"},
{"l":"spire/math/Complex.html","n":"/","t":"def /(b: Complex[T])(implicit f: Field[T], s: Signed[T]): Complex[T]","d":"spire/math/Complex","k":"def"},
{"l":"spire/math/Complex.html","n":"=!=","t":"def =!=(that: Complex[_]): Boolean","d":"spire/math/Complex","k":"def"},
{"l":"spire/math/Complex.html","n":"===","t":"def ===(that: Complex[_]): Boolean","d":"spire/math/Complex","k":"def"},
{"l":"spire/math/Complex.html","n":"abs","t":"def abs(implicit f: Field[T], n: NRoot[T], s: Signed[T]): T","d":"spire/math/Complex","k":"def"},
{"l":"spire/math/Complex.html","n":"absSquare","t":"def absSquare(implicit r: CommutativeRing[T]): T","d":"spire/math/Complex","k":"def"},
{"l":"spire/math/Complex.html","n":"acos","t":"def acos(implicit f: Field[T], n: NRoot[T], t: Trig[T], s0: Signed[T]): Complex[T]","d":"spire/math/Complex","k":"def"},
{"l":"spire/math/Complex.html","n":"arg","t":"def arg(implicit f: Field[T], s: Signed[T], t: Trig[T]): T","d":"spire/math/Complex","k":"def"},
{"l":"spire/math/Complex.html","n":"asPolarTuple","t":"def asPolarTuple(implicit f: Field[T], n: NRoot[T], s: Signed[T], t: Trig[T]): (T, T)","d":"spire/math/Complex","k":"def"},
{"l":"spire/math/Complex.html","n":"asTuple","t":"def asTuple: (T, T)","d":"spire/math/Complex","k":"def"},
{"l":"spire/math/Complex.html","n":"asin","t":"def asin(implicit f: Field[T], n: NRoot[T], t: Trig[T], s0: Signed[T]): Complex[T]","d":"spire/math/Complex","k":"def"},
{"l":"spire/math/Complex.html","n":"atan","t":"def atan(implicit f: Field[T], r: NRoot[T], t: Trig[T], s0: Signed[T]): Complex[T]","d":"spire/math/Complex","k":"def"},
{"l":"spire/math/Complex.html","n":"ceil","t":"def ceil(implicit o: IsReal[T]): Complex[T]","d":"spire/math/Complex","k":"def"},
{"l":"spire/math/Complex.html","n":"complexSignum","t":"def complexSignum(implicit f: Field[T], n: NRoot[T], s: Signed[T]): Complex[T]","d":"spire/math/Complex","k":"def"},
...
{"l":"spire/math/Complex.html","n":"log","t":"def log(implicit f: Field[T], n: NRoot[T], t: Trig[T], s: Signed[T]): Complex[T]","d":"spire/math/Complex","k":"def"},
{"l":"spire/math/Complex.html","n":"neqv","t":"def neqv(b: Complex[T])(implicit o: Eq[T]): Boolean","d":"spire/math/Complex","k":"def"},
{"l":"spire/math/Complex.html","n":"norm","t":"def norm(implicit f: Field[T], n: NRoot[T], s: Signed[T]): T","d":"spire/math/Complex","k":"def"},
{"l":"spire/math/Complex.html","n":"nroot","t":"def nroot(k: Int)(implicit f: Field[T], n: NRoot[T], s: Signed[T], t: Trig[T]): Complex[T]","d":"spire/math/Complex","k":"def"},
{"l":"spire/math/Complex.html","n":"pow","t":"def pow(e: T)(implicit f: Field[T], n: NRoot[T], s: Signed[T], t: Trig[T]): Complex[T]","d":"spire/math/Complex","k":"def"},
{"l":"spire/math/Complex.html","n":"pow","t":"def pow(b: Int)(implicit f: Field[T], n: NRoot[T], s: Signed[T], t: Trig[T]): Complex[T]","d":"spire/math/Complex","k":"def"},
{"l":"spire/math/Complex.html","n":"pow","t":"def pow(b: Complex[T])(implicit f: Field[T], n: NRoot[T], s: Signed[T], t: Trig[T]): Complex[T]","d":"spire/math/Complex","k":"def"},
...
{"l":"spire/math/Complex.html","n":"sqrt","t":"def sqrt(implicit f: Field[T], n0: NRoot[T], s: Signed[T]): Complex[T]","d":"spire/math/Complex","k":"def"},
...
{"l":"spire/math/Fractional.html","n":"Fractional","t":"trait Fractional[@specialized(Float, Double) A] extends Field[A] with NRoot[A] with Integral[A]","d":"spire/math/Fractional","k":"trait"},
...
{"l":"spire/math/Integral.html","n":"Integral","t":"trait Integral[@specialized(Int, Long) A] extends EuclideanRing[A] with ConvertableFrom[A] with ConvertableTo[A] with IsReal[A]","d":"spire/math/Integral","k":"trait"},
...
{"l":"spire/math/Jet.html","n":"**","t":"def **(b: Jet[T])(implicit c: ClassTag[T], f: Field[T], s: Signed[T], t: Trig[T], v: VectorSpace[Array[T], T]): Jet[T]","d":"spire/math/Jet","k":"def"},
...
{"l":"spire/math/Jet.html","n":"===","t":"def ===(that: Jet[_]): Boolean","d":"spire/math/Jet","k":"def"},
{"l":"spire/math/Jet.html","n":"abs","t":"def abs(implicit f: Field[T], s: Signed[T], v: VectorSpace[Array[T], T]): Jet[T]","d":"spire/math/Jet","k":"def"},
...
{"l":"spire/math/Jet.html","n":"nroot","t":"def nroot(k: Int)(implicit f: Field[T], s: Signed[T], t: Trig[T], v: VectorSpace[Array[T], T]): Jet[T]","d":"spire/math/Jet","k":"def"},
{"l":"spire/math/Jet.html","n":"pow","t":"def pow(p: T)(implicit f: Field[T], s: Signed[T], t: Trig[T], v: VectorSpace[Array[T], T]): Jet[T]","d":"spire/math/Jet","k":"def"},
{"l":"spire/math/Jet.html","n":"pow","t":"def pow(p: Int)(implicit f: Field[T], v: VectorSpace[Array[T], T]): Jet[T]","d":"spire/math/Jet","k":"def"},
{"l":"spire/math/Jet.html","n":"pow","t":"def pow(b: Jet[T])(implicit c: ClassTag[T], f: Field[T], m: CModule[Array[T], T], s: Signed[T], t: Trig[T]): Jet[T]","d":"spire/math/Jet","k":"def"},
{"l":"spire/math/Jet.html","n":"powScalarToJet","t":"def powScalarToJet(a: T)(implicit c: ClassTag[T], f: Field[T], m: CModule[Array[T], T], s: Signed[T], t: Trig[T]): Jet[T]","d":"spire/math/Jet","k":"def"},
...
{"l":"spire/math/JetInstances.html","n":"JetAlgebra","t":"def JetAlgebra[@specialized(Float, Double) T](implicit c: ClassTag[T], d: JetDim, f: Field[T], n: NRoot[T], s: Signed[T], t: Trig[T]): JetAlgebra[T]","d":"spire/math/JetInstances","k":"def"},
...
{"l":"spire/math/NaturalInstances.html","n":"NaturalAlgebra","t":"val NaturalAlgebra: CommutativeRig[Natural] & Order[Natural] & SignedAdditiveCMonoid[Natural] & TruncatedDivision[Natural]","d":"spire/math/NaturalInstances","k":"val"},
...
{"l":"spire/math/NumberInstances.html","n":"NumberAlgebra","t":"val NumberAlgebra: WithDefaultGCD[Number] & CommutativeRing[Number] & NRoot[Number] & Trig[Number] & IsRational[Number] & TruncatedDivisionCRing[Number] & Signed[Number] & Order[Number]","d":"spire/math/NumberInstances","k":"val"},
...
{"l":"spire/math/Polynomial.html","n":"signVariations","t":"def signVariations(implicit ring: Semiring[C], signed: Signed[C]): Int","d":"spire/math/Polynomial","k":"def"},
...
{"l":"spire/math/PolynomialOverField.html","n":"PolynomialOverField","t":"trait PolynomialOverField[@specialized(Double) C] extends PolynomialOverRing[C] with WithEuclideanAlgorithm[Polynomial[C]] with VectorSpace[Polynomial[C], C] with FieldAssociativeAlgebra[Polynomial[C], C]","d":"spire/math/PolynomialOverField","k":"trait"},
...
{"l":"spire/math/Quaternion.html","n":"fpow","t":"def fpow(k0: A)(implicit f: Field[A], nr: NRoot[A], si: Signed[A], tr: Trig[A]): Quaternion[A]","d":"spire/math/Quaternion","k":"def"},
...
{"l":"spire/math/Quaternion.html","n":"nroot","t":"def nroot(m: Int)(implicit f: Field[A], nr: NRoot[A], si: Signed[A], tr: Trig[A]): Quaternion[A]","d":"spire/math/Quaternion","k":"def"},
...
{"l":"spire/math/RationalInstances.html","n":"RationalAlgebra","t":"val RationalAlgebra: Field[Rational] & IsRational[Rational] & TruncatedDivisionCRing[Rational]","d":"spire/math/RationalInstances","k":"val"},
...
{"l":"spire/math/RealInstances.html","n":"algebra","t":"val algebra: Fractional[Real] & TruncatedDivisionCRing[Real] & Trig[Real] & WithDefaultGCD[Real]","d":"spire/math/RealInstances","k":"val"},
{"l":"spire/math/RealIsFractional.html","n":"RealIsFractional","t":"trait RealIsFractional extends Fractional[Real] with TruncatedDivisionCRing[Real] with Trig[Real] with WithDefaultGCD[Real]","d":"spire/math/RealIsFractional","k":"trait"},
...
{"l":"spire/math/UByteInstances.html","n":"UByteAlgebra","t":"val UByteAlgebra: CommutativeRig[UByte] & IsIntegral[UByte] & TruncatedDivision[UByte] & SignedAdditiveCMonoid[UByte]","d":"spire/math/UByteInstances","k":"val"},
...
{"l":"spire/math/UIntInstances.html","n":"UIntAlgebra","t":"val UIntAlgebra: CommutativeRig[UInt] & IsIntegral[UInt] & TruncatedDivision[UInt] & SignedAdditiveCMonoid[UInt]","d":"spire/math/UIntInstances","k":"val"},
...
{"l":"spire/math/ULongInstances.html","n":"ULongAlgebra","t":"val ULongAlgebra: CommutativeRig[ULong] & IsIntegral[ULong] & TruncatedDivision[ULong] & SignedAdditiveCMonoid[ULong]","d":"spire/math/ULongInstances","k":"val"},
...
{"l":"spire/math/UShortInstances.html","n":"UShortAlgebra","t":"val UShortAlgebra: CommutativeRig[UShort] & IsIntegral[UShort] & TruncatedDivision[UShort] & SignedAdditiveCMonoid[UShort]","d":"spire/math/UShortInstances","k":"val"},
...
{"l":"spire/math/extras/FixedPointInstances.html","n":"algebra","t":"def algebra(implicit scale: FixedScale): Fractional[FixedPoint] & TruncatedDivisionCRing[FixedPoint]","d":"spire/math/extras/FixedPointInstances","k":"def"},
...
{"l":"spire/random/Generator.html","n":"sampleFromTraversable","t":"def sampleFromTraversable[@specialized A : ClassTag](as: Iterable[A], size: Int)(implicit evidence$5: ClassTag[A], gen: Generator): Array[A]","d":"spire/random/Generator","k":"def"},
...
{"l":"spire/std/ArrayInstances0.html","n":"NI0","t":"type NI0[A] = NoImplicit[VectorSpace[Array[A], A]]","d":"spire/std/ArrayInstances0","k":"type"},
...
{"l":"spire/std/ArrayInstances1.html","n":"NI1","t":"type NI1[A] = NoImplicit[NormedVectorSpace[Array[A], A]]","d":"spire/std/ArrayInstances1","k":"type"},
...
{"l":"spire/std/BigDecimalInstances.html","n":"BigDecimalAlgebra","t":"val BigDecimalAlgebra: WithDefaultGCD[BigDecimal] & NRoot[BigDecimal] & IsRational[BigDecimal] & TruncatedDivisionCRing[BigDecimal] & Signed[BigDecimal] & Order[BigDecimal]","d":"spire/std/BigDecimalInstances","k":"val"},
...
{"l":"spire/std/BigDecimalIsField.html","n":"BigDecimalIsField","t":"trait BigDecimalIsField extends WithDefaultGCD[BigDecimal]","d":"spire/std/BigDecimalIsField","k":"trait"},
...
{"l":"spire/std/BigDecimalTruncatedDivision.html","n":"BigDecimalTruncatedDivision","t":"trait BigDecimalTruncatedDivision extends TruncatedDivisionCRing[BigDecimal] with BigDecimalSigned","d":"spire/std/BigDecimalTruncatedDivision","k":"trait"},
...
{"l":"spire/std/BigIntInstances.html","n":"BigIntAlgebra","t":"val BigIntAlgebra: EuclideanRing[BigInt] & NRoot[BigInt] & MetricSpace[BigInt, BigInt] & IsIntegral[BigInt] & TruncatedDivisionCRing[BigInt] & Signed[BigInt] & Order[BigInt]","d":"spire/std/BigIntInstances","k":"val"},
...
{"l":"spire/std/BigIntTruncatedDivision.html","n":"BigIntTruncatedDivision","t":"trait BigIntTruncatedDivision extends TruncatedDivisionCRing[BigInt] with BigIntSigned","d":"spire/std/BigIntTruncatedDivision","k":"trait"},
...
{"l":"spire/std/BigIntegerInstances.html","n":"BigIntegerAlgebra","t":"val BigIntegerAlgebra: EuclideanRing[BigInteger] & NRoot[BigInteger] & MetricSpace[BigInteger, BigInteger] & IsIntegral[BigInteger] & TruncatedDivisionCRing[BigInteger] & Signed[BigInteger] & Order[BigInteger]","d":"spire/std/BigIntegerInstances","k":"val"},
...
{"l":"spire/std/BigIntegerIsEuclideanRing.html","n":"gcd","t":"def gcd(a: BigInteger, b: BigInteger)(implicit ev: Eq[BigInteger]): BigInteger","d":"spire/std/BigIntegerIsEuclideanRing","k":"def"},
{"l":"spire/std/BigIntegerIsEuclideanRing.html","n":"lcm","t":"def lcm(a: BigInteger, b: BigInteger)(implicit ev: Eq[BigInteger]): BigInteger","d":"spire/std/BigIntegerIsEuclideanRing","k":"def"},
...
{"l":"spire/std/BigIntegerTruncatedDivision.html","n":"BigIntegerTruncatedDivision","t":"trait BigIntegerTruncatedDivision extends TruncatedDivisionCRing[BigInteger] with BigIntegerSigned","d":"spire/std/BigIntegerTruncatedDivision","k":"trait"},
...
{"l":"spire/std/ByteInstances.html","n":"ByteAlgebra","t":"val ByteAlgebra: EuclideanRing[Byte] & IsIntegral[Byte] & TruncatedDivisionCRing[Byte] & Signed[Byte] & Order[Byte]","d":"spire/std/ByteInstances","k":"val"},
...
{"l":"spire/std/ByteIsEuclideanRing.html","n":"gcd","t":"def gcd(a: Byte, b: Byte)(implicit ev: Eq[Byte]): Byte","d":"spire/std/ByteIsEuclideanRing","k":"def"},
{"l":"spire/std/ByteIsEuclideanRing.html","n":"lcm","t":"def lcm(a: Byte, b: Byte)(implicit ev: Eq[Byte]): Byte","d":"spire/std/ByteIsEuclideanRing","k":"def"},
...
{"l":"spire/std/ByteTruncatedDivision.html","n":"ByteTruncatedDivision","t":"trait ByteTruncatedDivision extends TruncatedDivisionCRing[Byte] with ByteSigned","d":"spire/std/ByteTruncatedDivision","k":"trait"},
...
{"l":"spire/std/DoubleInstances.html","n":"DoubleAlgebra","t":"val DoubleAlgebra: WithDefaultGCD[Double] & NRoot[Double] & Trig[Double] & IsRational[Double] & TruncatedDivisionCRing[Double] & Signed[Double] & Order[Double]","d":"spire/std/DoubleInstances","k":"val"},
{"l":"spire/std/DoubleInstances.html","n":"DoubleTag","t":"val DoubleTag: NumberTag[Double]","d":"spire/std/DoubleInstances","k":"val"},
{"l":"spire/std/DoubleIsField.html","n":"DoubleIsField","t":"trait DoubleIsField extends WithDefaultGCD[Double]","d":"spire/std/DoubleIsField","k":"trait"},
...
{"l":"spire/std/DoubleTruncatedDivision.html","n":"DoubleTruncatedDivision","t":"trait DoubleTruncatedDivision extends TruncatedDivisionCRing[Double] with DoubleSigned","d":"spire/std/DoubleTruncatedDivision","k":"trait"},
...
{"l":"spire/std/FloatInstances.html","n":"FloatAlgebra","t":"val FloatAlgebra: WithDefaultGCD[Float] & NRoot[Float] & Trig[Float] & IsRational[Float]","d":"spire/std/FloatInstances","k":"val"},
{"l":"spire/std/FloatInstances.html","n":"FloatTag","t":"val FloatTag: NumberTag[Float]","d":"spire/std/FloatInstances","k":"val"},
{"l":"spire/std/FloatIsField.html","n":"FloatIsField","t":"trait FloatIsField extends WithDefaultGCD[Float]","d":"spire/std/FloatIsField","k":"trait"},
...
{"l":"spire/std/FloatTruncatedDivision.html","n":"FloatTruncatedDivision","t":"trait FloatTruncatedDivision extends TruncatedDivisionCRing[Float] with FloatSigned","d":"spire/std/FloatTruncatedDivision","k":"trait"},
...
{"l":"spire/std/IntInstances.html","n":"IntAlgebra","t":"val IntAlgebra: EuclideanRing[Int] & NRoot[Int] & IsIntegral[Int] & TruncatedDivisionCRing[Int] & Signed[Int] & Order[Int]","d":"spire/std/IntInstances","k":"val"},
...
{"l":"spire/std/IntIsEuclideanRing.html","n":"gcd","t":"def gcd(a: Int, b: Int)(implicit ev: Eq[Int]): Int","d":"spire/std/IntIsEuclideanRing","k":"def"},
{"l":"spire/std/IntIsEuclideanRing.html","n":"lcm","t":"def lcm(a: Int, b: Int)(implicit ev: Eq[Int]): Int","d":"spire/std/IntIsEuclideanRing","k":"def"},
...
{"l":"spire/std/IntTruncatedDivision.html","n":"IntTruncatedDivision","t":"trait IntTruncatedDivision extends TruncatedDivisionCRing[Int] with IntSigned","d":"spire/std/IntTruncatedDivision","k":"trait"},
...
{"l":"spire/std/LongInstances.html","n":"LongAlgebra","t":"val LongAlgebra: EuclideanRing[Long] & NRoot[Long] & IsIntegral[Long] & TruncatedDivisionCRing[Long] & Signed[Long] & Order[Long]","d":"spire/std/LongInstances","k":"val"},
...
{"l":"spire/std/LongIsEuclideanRing.html","n":"gcd","t":"def gcd(a: Long, b: Long)(implicit ev: Eq[Long]): Long","d":"spire/std/LongIsEuclideanRing","k":"def"},
{"l":"spire/std/LongIsEuclideanRing.html","n":"lcm","t":"def lcm(a: Long, b: Long)(implicit ev: Eq[Long]): Long","d":"spire/std/LongIsEuclideanRing","k":"def"},
...
{"l":"spire/std/LongTruncatedDivision.html","n":"LongTruncatedDivision","t":"trait LongTruncatedDivision extends TruncatedDivisionCRing[Long] with LongSigned","d":"spire/std/LongTruncatedDivision","k":"trait"},
...
{"l":"spire/std/SeqInstances0.html","n":"SeqCModule","t":"def SeqCModule[A, CC <: (SeqOps)](implicit ring0: CommutativeRing[A], cbf0: Factory[A, CC[A]], ev: NoImplicit[VectorSpace[CC[A], A]]): SeqCModule[A, CC[A]]","d":"spire/std/SeqInstances0","k":"def"},
...
{"l":"spire/std/SeqInstances1.html","n":"SeqVectorSpace","t":"def SeqVectorSpace[A, CC <: (SeqOps)](implicit field0: Field[A], cbf0: Factory[A, CC[A]], ev: NoImplicit[NormedVectorSpace[CC[A], A]]): SeqVectorSpace[A, CC[A]]","d":"spire/std/SeqInstances1","k":"def"},
...
{"l":"spire/std/ShortInstances.html","n":"ShortAlgebra","t":"val ShortAlgebra: EuclideanRing[Short] & IsIntegral[Short] & TruncatedDivisionCRing[Short] & Signed[Short] & Order[Short]","d":"spire/std/ShortInstances","k":"val"},
...
{"l":"spire/std/ShortIsEuclideanRing.html","n":"gcd","t":"def gcd(a: Short, b: Short)(implicit ev: Eq[Short]): Short","d":"spire/std/ShortIsEuclideanRing","k":"def"},
{"l":"spire/std/ShortIsEuclideanRing.html","n":"lcm","t":"def lcm(a: Short, b: Short)(implicit ev: Eq[Short]): Short","d":"spire/std/ShortIsEuclideanRing","k":"def"},
...
{"l":"spire/std/ShortTruncatedDivision.html","n":"ShortTruncatedDivision","t":"trait ShortTruncatedDivision extends TruncatedDivisionCRing[Short] with ShortSigned","d":"spire/std/ShortTruncatedDivision","k":"trait"},
...
{"l":"spire/syntax/TruncatedDivisionOps.html","n":"toBigIntOpt","t":"def toBigIntOpt: Opt[BigInt]","d":"spire/syntax/TruncatedDivisionOps","k":"def"},
...
{"l":"spire/syntax/macros.html","n":"fastForInline","t":"def fastForInline[R](init: R, test: R => Boolean, next: R => R, body: R => Unit): Unit","d":"spire/syntax/macros","k":"def"},
{"l":"spire/syntax/macros.html","n":"fastForRangeMacro","t":"def fastForRangeMacro(r: Expr[Range], body: Expr[Int => Unit])(using quotes: Quotes): Expr[Unit]","d":"spire/syntax/macros","k":"def"},
{"l":"spire/syntax/macros.html","n":"fastForRangeMacroGen","t":"def fastForRangeMacroGen[R <: RangeLike : Type](r: Expr[R], body: Expr[RangeElem[R] => Unit])(implicit evidence$1: Type[R], quotes: Quotes): Expr[Unit]","d":"spire/syntax/macros","k":"def"},
{"l":"spire/syntax/macros.html","n":"fastForRangeMacroLong","t":"def fastForRangeMacroLong(r: Expr[NumericRange[Long]], body: Expr[Long => Unit])(using quotes: Quotes): Expr[Unit]","d":"spire/syntax/macros","k":"def"},
