...
class LawTests extends FunSuite with Discipline {
  ...
  checkAll("BigInt",     BaseLaws[BigInt].signedGCDRing)
  checkAll("BigInteger", RingLaws[BigInteger].euclideanRing)
  checkAll("BigInteger",     BaseLaws[BigInteger].signedGCDRing)
  checkAll("Rational",   RingLaws[Rational].field)
  checkAll("Rational",   BaseLaws[BigInt].signedGCDRing)
  ...
  checkAll("SafeLong",   BaseLaws[SafeLong].signedGCDRing)
