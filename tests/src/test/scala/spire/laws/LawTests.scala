...
//  checkAll("Byte",       RingLaws[Byte].euclideanRingLimitedRange) // fail on pow
  checkAll("Byte",       OrderLaws[Byte].truncatedDivisionLimitedRange)
//  checkAll("Short",      RingLaws[Short].euclideanRingLimitedRange)
  checkAll("Short",      OrderLaws[Short].truncatedDivisionLimitedRange)
  checkAll("Int",        RingLaws[Int].euclideanRingLimitedRange)
  checkAll("Int",        OrderLaws[Int].truncatedDivisionLimitedRange)
  checkAll("Int",        BaseLaws[Int].uniqueFactorizationDomain)
  checkAll("Long",       RingLaws[Long].euclideanRingLimitedRange)
  checkAll("Long",       OrderLaws[Long].truncatedDivisionLimitedRange)
  ...
  checkAll("Rational",   OrderLaws[BigInt].signedAdditiveAbGroup)
  ...
  checkAll("UInt",       OrderLaws[UInt].truncatedDivisionLimitedRange)
  checkAll("ULong",      RingLaws[ULong].cRig)
  checkAll("ULong",      OrderLaws[ULong].truncatedDivisionLimitedRange)
